<?php
// modules/configuracoes/facial.php - Configurações de Reconhecimento Facial (CORRIGIDO)
session_start();
...
try {
    $colunas = [
        'facial_obrigatorio' => "ALTER TABLE config_facial ADD COLUMN facial_obrigatorio BIT(1) DEFAULT 1",
        'confianca_minima' => "ALTER TABLE config_facial ADD COLUMN confianca_minima INT DEFAULT 70",
        'tentativas_maximas' => "ALTER TABLE config_facial ADD COLUMN tentativas_maximas INT DEFAULT 3",
        'permitir_fallback' => "ALTER TABLE config_facial ADD COLUMN permitir_fallback BIT(1) DEFAULT 1",
        'qualidade_imagem' => "ALTER TABLE config_facial ADD COLUMN qualidade_imagem BIT(1) DEFAULT 1",
        'detectar_expressao' => "ALTER TABLE config_facial ADD COLUMN detectar_expressao BIT(1) DEFAULT 0",
        'validar_vivo' => "ALTER TABLE config_facial ADD COLUMN validar_vivo BIT(1) DEFAULT 0",
        'tempo_maximo_captura' => "ALTER TABLE config_facial ADD COLUMN tempo_maximo_captura INT DEFAULT 30",
        'zoom_automatico' => "ALTER TABLE config_facial ADD COLUMN zoom_automatico BIT(1) DEFAULT 1"
    ];
...
$defaults = [
    'facial_obrigatorio' => 1,
    'confianca_minima' => 70,
    'tentativas_maximas' => 3,
    'permitir_fallback' => 1,
    'qualidade_imagem' => 1,
    'detectar_expressao' => 0,
    'validar_vivo' => 0,
    'tempo_maximo_captura' => 30,
    'zoom_automatico' => 1
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $config['tentativas_maximas'] = $tentativas_maximas;
        $config['permitir_fallback'] = $permitir_fallback;
        $config['qualidade_imagem'] = $qualidade_imagem;
        $config['detectar_expressao'] = $detectar_expressao;
        $config['validar_vivo'] = $validar_vivo;
        $config['tempo_maximo_captura'] = $tempo_maximo_captura;
        $config['zoom_automatico'] = $zoom_automatico;
