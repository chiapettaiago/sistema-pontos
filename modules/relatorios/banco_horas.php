...
<div class="relatorio-container">
    <div class="module-header">
        ...
        <div class="module-actions">
            <a href="exportar_excel?tipo=banco_horas&funcionario_id=<?php echo $funcionario_id; ?>" class="btn-exportar btn-excel">
                <i class="fas fa-file-excel"></i> Exportar Excel
            </a>
            <a href="exportar_pdf?tipo=banco_horas&funcionario_id=<?php echo $funcionario_id; ?>" class="btn-exportar btn-pdf" target="_blank">
