...
<body>
    ...
    <?php elseif ($tipo == 'pontos_funcionario'): ?>
        ...
        ?>
            ...
            <table>
                ...
                ?>
                    <tr>
                        <td colspan="7" style="text-align: center;">Nenhum registro encontrado no período</td>
                    </tr>
                <?php 
                endif;
                ?>
    ...
    <?php elseif ($tipo == 'horas_trabalhadas'): ?>
        ...
        <table>
            <thead>
                <tr><th>Funcionário</th><th>Data</th><th>Entrada</th><th>Saída</th><th>Horas Normais</th><th>Horas Extras</th><th>Horas a Compensar</th><th>Status</th></tr>
            </thead>
            <tbody>
            <?php
