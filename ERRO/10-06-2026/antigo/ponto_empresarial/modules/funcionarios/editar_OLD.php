<?php
// modules/funcionarios/editar.php - Editar Funcionário (COM VALIDAÇÃO DE CPF)
...
// Verificar permissão (gestor só pode editar funcionários da sua filial)
if ($_SESSION['usuario_tipo'] !== 'super_admin' && $_SESSION['usuario_tipo'] !== 'admin' && $funcionario['filial_id'] != $_SESSION['usuario_filial_id']) {
    header('Location: index.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($cpf)) {
        ...
        // Verificar CPF duplicado na mesma empresa (excluindo o próprio funcionário)
    ...
    // Validar email único na empresa (excluindo o próprio)
    ...
    // Validar matrícula única na empresa (excluindo o próprio)
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <small>Digite um CPF válido (não pode ser duplicado na empresa)</small>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="estado">
                            ...
                            <option value="AC" <?php echo ($funcionario['estado'] ?? '') == 'AC' ? 'selected' : ''; ?>>AC</option>
                            <option value="AL" <?php echo ($funcionario['estado'] ?? '') == 'AL' ? 'selected' : ''; ?>>AL</option>
                            <option value="AP" <?php echo ($funcionario['estado'] ?? '') == 'AP' ? 'selected' : ''; ?>>AP</option>
                            <option value="AM" <?php echo ($funcionario['estado'] ?? '') == 'AM' ? 'selected' : ''; ?>>AM</option>
                            <option value="BA" <?php echo ($funcionario['estado'] ?? '') == 'BA' ? 'selected' : ''; ?>>BA</option>
                            <option value="CE" <?php echo ($funcionario['estado'] ?? '') == 'CE' ? 'selected' : ''; ?>>CE</option>
                            <option value="DF" <?php echo ($funcionario['estado'] ?? '') == 'DF' ? 'selected' : ''; ?>>DF</option>
                            <option value="ES" <?php echo ($funcionario['estado'] ?? '') == 'ES' ? 'selected' : ''; ?>>ES</option>
                            <option value="GO" <?php echo ($funcionario['estado'] ?? '') == 'GO' ? 'selected' : ''; ?>>GO</option>
                            <option value="MA" <?php echo ($funcionario['estado'] ?? '') == 'MA' ? 'selected' : ''; ?>>MA</option>
                            <option value="MT" <?php echo ($funcionario['estado'] ?? '') == 'MT' ? 'selected' : ''; ?>>MT</option>
                            <option value="MS" <?php echo ($funcionario['estado'] ?? '') == 'MS' ? 'selected' : ''; ?>>MS</option>
                            <option value="MG" <?php echo ($funcionario['estado'] ?? '') == 'MG' ? 'selected' : ''; ?>>MG</option>
                            <option value="PA" <?php echo ($funcionario['estado'] ?? '') == 'PA' ? 'selected' : ''; ?>>PA</option>
                            <option value="PB" <?php echo ($funcionario['estado'] ?? '') == 'PB' ? 'selected' : ''; ?>>PB</option>
                            <option value="PR" <?php echo ($funcionario['estado'] ?? '') == 'PR' ? 'selected' : ''; ?>>PR</option>
                            <option value="PE" <?php echo ($funcionario['estado'] ?? '') == 'PE' ? 'selected' : ''; ?>>PE</option>
                            <option value="PI" <?php echo ($funcionario['estado'] ?? '') == 'PI' ? 'selected' : ''; ?>>PI</option>
                            <option value="RJ" <?php echo ($funcionario['estado'] ?? '') == 'RJ' ? 'selected' : ''; ?>>RJ</option>
                            <option value="RN" <?php echo ($funcionario['estado'] ?? '') == 'RN' ? 'selected' : ''; ?>>RN</option>
                            <option value="RS" <?php echo ($funcionario['estado'] ?? '') == 'RS' ? 'selected' : ''; ?>>RS</option>
                            <option value="RO" <?php echo ($funcionario['estado'] ?? '') == 'RO' ? 'selected' : ''; ?>>RO</option>
                            <option value="RR" <?php echo ($funcionario['estado'] ?? '') == 'RR' ? 'selected' : ''; ?>>RR</option>
                            <option value="SC" <?php echo ($funcionario['estado'] ?? '') == 'SC' ? 'selected' : ''; ?>>SC</option>
                            <option value="SP" <?php echo ($funcionario['estado'] ?? '') == 'SP' ? 'selected' : ''; ?>>SP</option>
                            <option value="SE" <?php echo ($funcionario['estado'] ?? '') == 'SE' ? 'selected' : ''; ?>>SE</option>
                            <option value="TO" <?php echo ($funcionario['estado'] ?? '') == 'TO' ? 'selected' : ''; ?>>TO</option>
                        </select>
                    </div>
                </div>
            </div>
...
<style>
.foto-container { display: flex; align-items: center; gap: 24px; flex-wrap: wrap; }
.foto-preview { width: 150px; height: 150px; border-radius: 50%; background: #f3f4f6; display: flex; align-items: center; justify-content: center; overflow: hidden; border: 3px solid #e5e5e5; }
.foto-preview i { font-size: 80px; color: #9ca3af; }
.foto-preview img { width: 100%; height: 100%; object-fit: cover; }
.btn-danger { background: #fee2e2; color: #dc2626; border-color: #dc2626; }
.btn-danger:hover { background: #dc2626; color: white; }
.form-section { margin-bottom: 32px; padding-bottom: 24px; border-bottom: 1px solid #e5e5e5; }
.form-section h4 { margin-bottom: 20px; color: #333; font-size: 18px; }
.form-section h4 i { color: #667eea; margin-right: 8px; }
