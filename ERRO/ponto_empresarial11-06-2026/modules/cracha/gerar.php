<?php
// modules/cracha/gerar.php - Geração do PDF do Crachá (COM QR CODE CORRIGIDO)
...
// Dados para o QR Code (com link para validação)
...
function gerarQRCode($texto) {
    $tamanho = 150;
    $url = "https://quickchart.io/qr?text=" . urlencode($texto) . "&size={$tamanho}&margin=2";
    return $url;
}

$qrCodeUrl = gerarQRCode($url_validacao);
        ...
        <div class="cracha">
            ...
            <div class="cracha-body">
                ...
                <div class="cracha-qrcode">
                    <img src="<?php echo $qrCodeUrl; ?>" alt="QR Code para validação">
                    <p><i class="fas fa-qrcode"></i> Escaneie para validar o crachá</p>
                </div>
            </div>
