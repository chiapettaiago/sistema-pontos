...
<div class="relatorio-container">
    <div class="module-header">
        ...
        <div class="module-actions">
            <a href="exportar_excel?tipo=extrato_funcionario&funcionario_id=<?php echo $funcionario_id; ?>&data_inicio=<?php echo $data_inicio; ?>&data_fim=<?php echo $data_fim; ?>" class="btn-exportar btn-excel">
                <i class="fas fa-file-excel"></i> Exportar Excel
            </a>
            <a href="exportar_pdf?tipo=extrato_funcionario&funcionario_id=<?php echo $funcionario_id; ?>&data_inicio=<?php echo $data_inicio; ?>&data_fim=<?php echo $data_fim; ?>" class="btn-exportar btn-pdf" target="_blank">
