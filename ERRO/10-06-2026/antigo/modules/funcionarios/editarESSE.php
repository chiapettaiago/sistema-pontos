<?php
// modules/funcionarios/editar.php - Editar Funcionário (COM DETECÇÃO FACIAL AVANÇADA)
        ...
        <form method="POST" action="" class="form-main" enctype="multipart/form-data" id="editarForm">
            ...
            <div class="form-section">
                ...
                <div class="foto-container">
                    ...
                    <small><i class="fas fa-info-circle"></i> A foto do rosto será usada para reconhecimento facial. Centralize o rosto e mantenha os olhos nos pontos.</small>
                </div>
            </div>
...
<script>
// ============================================
// DETECÇÃO FACIAL AVANÇADA (ROSTO + OLHOS + ÍRIS) - EDITAR
// ============================================
