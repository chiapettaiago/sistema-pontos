...
<div class="relatorio-container">
    <div class="module-header">
        ...
        <div class="module-actions">
            <a href="exportar_excel?tipo=horas_trabalhadas&periodo=<?php echo $periodo; ?>&data_referencia=<?php echo $data_referencia; ?>&funcionario_id=<?php echo $funcionario_id; ?>&ano=<?php echo $ano; ?>&mes=<?php echo $mes; ?>&semana=<?php echo $semana; ?>" class="btn-exportar btn-excel">
                <i class="fas fa-file-excel"></i> Exportar Excel
            </a>
            <a href="exportar_pdf?tipo=horas_trabalhadas&periodo=<?php echo $periodo; ?>&data_referencia=<?php echo $data_referencia; ?>&funcionario_id=<?php echo $funcionario_id; ?>&ano=<?php echo $ano; ?>&mes=<?php echo $mes; ?>&semana=<?php echo $semana; ?>" class="btn-exportar btn-pdf" target="_blank">
