<?php
// modules/ponto/extrato.php - Meu Extrato (VERSÃO FUNCIONÁRIO)
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="7" style="text-align: center; padding: 60px;">
                            ...
                            <p style="margin-top: 16px; color: var(--text-secondary);">Nenhum registro encontrado neste período</p>
                            <p style="font-size: 12px; color: var(--text-secondary);">Use o menu "Registrar Ponto" para bater seu ponto.</p>
                        </td>
                    </tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php elseif ($dia['saida']): ?>
                                    <span class="status-incompleto">❌ Sem entrada</span>
                                <?php else: ?>
