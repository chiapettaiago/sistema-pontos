<?php
// login.php - Sistema de Login Unificado (Usuários do Sistema + Funcionários)
session_start();
    ...
    if (empty($email) || empty($senha)) {
        ...
        try {
            ...
            if ($funcionario && password_verify($senha, $funcionario['senha'])) {
                ...
                // Redirecionar para área do funcionário (bater ponto)
                header('Location: modules/ponto/ponto.php');
                exit;
            }
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="test-users">
                ...
                <small><i class="fas fa-user-check"></i> <strong>Funcionário:</strong> email do funcionário cadastrado / senha definida</small>
            </div>
