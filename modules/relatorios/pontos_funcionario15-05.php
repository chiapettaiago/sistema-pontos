...
<div class="relatorio-container">
    <div class="module-header">
        <div class="module-title">
            ...
            <p><?php echo $funcionario_nome; ?> - <?php echo $nomes_meses[$mes_num] . ' de ' . $ano; ?></p>
        </div>
        <div class="module-actions">
            ...
            <a href="exportar_pdf?tipo=pontos_funcionario&funcionario_id=<?php echo $funcionario_id; ?>&mes=<?php echo $mes; ?>" class="btn-exportar btn-pdf" target="_blank">
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="fade-in">
                            ...
                            <td><?php echo $dias_semana[$reg['dia_semana']]; ?></td>
