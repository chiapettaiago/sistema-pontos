<?php
// login.php - Sistema de Login Unificado (CORRIGIDO - COM REDIRECIONAMENTOS CORRETOS)
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($senha)) {
        ...
        try {
            ...
            // ============================================
            // SEGUNDO: Tentar como FUNCIONÁRIO (tabela funcionarios)
            // ============================================
            $query2 = "SELECT f.*, 
            ...
            if ($funcionario && password_verify($senha, $funcionario['senha'])) {
                ...
                // Redirecionar para tela de ponto
                header('Location: modules/ponto/ponto.php');
                exit;
            }
