...
<?php if ($success): ?><div class="alert alert-success"><i class="fas fa-circle-check me-2"></i><?= htmlspecialchars($success) ?></div><?php endif; ?>
