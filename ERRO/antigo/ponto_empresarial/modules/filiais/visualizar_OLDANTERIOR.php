<?php
// modules/filiais/visualizar.php - Visualizar Filial (CORRIGIDO)
...
// Buscar dados da filial (SEM empresa_id na query)
$query = "SELECT f.*, 
...
// Buscar funcionários da filial
$query_func = "SELECT id, nome, matricula, cargo, status, email 
               FROM funcionarios 
               WHERE filial_id = :id 
               ORDER BY nome ASC";
            ...
            <table class="funcionarios-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($func['cargo'] ?: 'Não definido'); ?></td>
