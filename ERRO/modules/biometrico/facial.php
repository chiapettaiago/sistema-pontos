...
// Buscar dados do funcionário apenas da empresa atual
$query = "SELECT nome, matricula FROM funcionarios WHERE id = :id AND empresa_id = :empresa_id";
...
<div class="facial-container">
    <div class="video-card">
        ...
        <div class="stepper" style="grid-template-columns: repeat(5, 1fr);">
            <div class="step-item"><strong>1. Abrir</strong> câmera e verificar iluminação.</div>
            <div class="step-item"><strong>2. Centralizar</strong> o rosto dentro do guia.</div>
            <div class="step-item"><strong>3. Capturar</strong> a primeira amostra.</div>
            <div class="step-item"><strong>4. Repetir</strong> mais 4 variações do rosto.</div>
            <div class="step-item"><strong>5. Salvar</strong> confirmar o envio final.</div>
        </div>
