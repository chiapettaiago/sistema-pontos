...
// Query base (REMOVIDA referência a aprovado_por)
$query = "SELECT s.*, 
...
<?php else: ?>
    ...
    <div class="solicitacao-card">
        ...
        <?php elseif ($s['motivo']): ?>
        <div class="solicitacao-descricao">
            <i class="fas fa-comment"></i> <?php echo nl2br(htmlspecialchars($s['motivo'])); ?>
        </div>
        <?php endif; ?>
        
        <div class="solicitacao-footer">
            <span>
                <i class="fas fa-clock"></i> Solicitado em: <?php echo date('d/m/Y H:i', strtotime($s['created_at'])); ?>
            </span>
