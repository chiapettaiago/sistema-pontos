<?php
// modules/cracha/meu_cracha.php - Crachá Digital do Funcionário (COM WALLET)
...
// Se for dispositivo móvel, mostrar dica no console
if (isMobile) {
    console.log('📱 Dispositivo móvel detectado! O botão "+ Carteira Digital" irá gerar o QR Code para adicionar à sua carteira.');
}
