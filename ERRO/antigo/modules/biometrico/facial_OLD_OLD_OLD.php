<?php
// modules/biometrico/facial.php - Cadastro Facial (VERSÃO CDN GARANTIDA)
...
// ============================================
// CARREGAR MODELOS - VERSÃO CDN OFICIAL
// ============================================
async function loadModels() {
    // Usar CDN oficial do face-api.js
...
async function checkCamera() {
    if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
        updateStatusText('❌ Seu navegador não suporta acesso à câmera. Use Chrome ou Edge.', 'error');
        return false;
    }
