<?php
// modules/funcionarios/cadastrar.php - Cadastrar Novo Funcionário (COM VALIDAÇÃO DE CPF)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($cpf)) {
        ...
        if ($check->fetch()) {
            $errors[] = 'CPF já cadastrado para esta empresa';
        }
    }
    
    // Validar email único na empresa
    ...
    // Validar matrícula única na empresa
...
<!-- O resto do HTML permanece igual ao que já existe -->
        ...
        <form method="POST" action="" class="form-main" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label>CPF *</label>
                        <input type="text" name="cpf" id="cpf" required value="<?php echo htmlspecialchars($_POST['cpf'] ?? ''); ?>" placeholder="000.000.000-00">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="filial_id" required>
                            ...
                            <option value="<?php echo $filial['id']; ?>"><?php echo htmlspecialchars($filial['nome_fantasia']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="departamento_id">
                            ...
                            <option value="<?php echo $depto['id']; ?>"><?php echo htmlspecialchars($depto['nome']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jornada_id">
                            ...
                            <option value="<?php echo $jornada['id']; ?>"><?php echo htmlspecialchars($jornada['nome']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="checkbox-group">
                            <label><input type="checkbox" name="pode_gerenciar_filiais" value="1"> Pode gerenciar filiais</label>
                            <label><input type="checkbox" name="pode_gerenciar_funcionarios" value="1"> Pode gerenciar funcionários</label>
                            <label><input type="checkbox" name="pode_ver_relatorios" value="1"> Pode ver relatórios</label>
                        </div>
                    </div>
                </div>
            </div>
