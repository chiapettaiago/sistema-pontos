<?php
// modules/empresa/dashboard.php - Dashboard do Admin Empresa
$pageTitle = 'Dashboard Empresa';
$activePage = 'empresa_dashboard';
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <div class="progress-bar">
                <div class="progress-fill" style="width: <?php echo ($empresa['total_funcionarios'] / $assinatura['recurso_funcionarios']) * 100; ?>%"></div>
            </div>
            <?php endif; ?>
        </div>
    </div>
