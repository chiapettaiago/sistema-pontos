    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <br>
                <a href='http://localhost/ponto_empresarial/' class='button'>Acessar Sistema</a>
            </div>
            <div class='footer'>
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <br>
                <a href='http://localhost/ponto_empresarial/modules/ponto/registrar.php' class='button'>Registrar Ponto Agora</a>
            </div>
            <div class='footer'>
                <p>Este é um e-mail automático, por favor não responda.</p>
                <p>&copy; 2024 Ponto Fácil - Todos os direitos reservados</p>
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <br>
                <a href='http://localhost/ponto_empresarial/modules/ponto/justificar.php' class='button'>Justificar Atraso</a>
            </div>
            <div class='footer'>
                <p>Este é um e-mail automático, por favor não responda.</p>
                <p>&copy; 2024 Ponto Fácil - Todos os direitos reservados</p>
